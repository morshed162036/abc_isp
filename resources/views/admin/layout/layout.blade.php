                ...
                <div class="navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                                <div class="user-nav d-sm-flex d-none"><span class="user-name">{{ Auth::guard('admin')->user()->name }}</span><span class="user-status text-muted">{{ Auth::guard('admin')->user()->Role }}</span></div><span><img class="round" src="{{ asset('admin_template/app-assets/images/portrait/small/avatar-s-11.jpg') }}" alt="avatar" height="40" width="40"></span>
                            </a>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="{{ route('admin.dashboard') }}">
                        <div class="brand-logo"><img class="logo" src="{{ asset('admin_template/app-assets/images/logo/logo.png') }}" /></div>
                        <h2 class="brand-text mb-0">ABC Isp</h2>
                    </a></li>
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="">
                ...
                <li class=" navigation-header"><span>Support Team</span>
                </li>
                <li class=" nav-item"><a href="{{ route('support-team.index') }}"><i class="bx bx-envelope"></i><span class="menu-title" data-i18n="Email">Support Team</span></a>
                </li>
                <li class=" nav-item"><a href="{{ route('team_members') }}"><i class="bx bx-chat"></i><span class="menu-title" data-i18n="Chat">Team Members</span></a>
                </li>
                
                <li class=" navigation-header"><span>Role</span>
                </li>
                <li class=" nav-item"><a href="colors.html') }}"><i class="bx bx-droplet"></i><span class="menu-title" data-i18n="Colors">Job Description</span></a>
                </li>
                <li class=" nav-item"><a href="#"><i class="bx bx-bulb"></i><span class="menu-title" data-i18n="Icons">Role & Permission</span></a>
                    <ul class="menu-content">
                        <li><a href="{{ route('role.index') }}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="LivIcons">Role</span></a>
                        </li>
                        <li><a href="{{ route('permission.index') }}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="boxicons">Permission</span></a>
                        </li>
                    </ul>
                </li>
                <li class=" navigation-header"><span>Users</span>
                </li>
                <li class=" nav-item"><a href="{{ route('admin.index') }}"><i class="bx bx-list-plus"></i><span class="menu-title" data-i18n="Form Wizard">Office User</span></a>
                </li>
                <li class=" nav-item"><a href="{{ url('admin/customer') }}"><i class="bx bx-check-shield"></i><span class="menu-title" data-i18n="Form Validation">Customer</span></a>
                </li>
                <li class=" navigation-header"><span>Complain</span>
                </li>
                <li class=" nav-item"><a href="page-user-profile.html') }}"><i class="bx bx-user"></i><span class="menu-title" data-i18n="User Profile">Manage Complain</span></a>
                </li>
                <li class=" nav-item"><a href="page-faq.html') }}"><i class="bx bx-help-circle"></i><span class="menu-title" data-i18n="FAQ">Search Customer History</span></a>
                </li>
